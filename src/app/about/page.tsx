    ...
    <div>
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 text-paper-100/65 sm:px-6">
        <p className="leading-relaxed">
          EvalOtter started from a simple frustration: most online quizzes optimize for virality,
        ...
        <p className="mt-5 leading-relaxed">
          ...
          can&apos;t claim — every EvalOtter assessment is designed for education, entertainment and
